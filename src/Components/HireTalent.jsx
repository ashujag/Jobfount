...
const HireTalentPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <button
        onClick={() => navigate('/')}
        className="absolute top-4 left-4 z-50 flex items-center px-4 py-2 bg-white text-gray-800 rounded-full shadow-lg hover:bg-gray-100 transition-colors duration-200"
      >
      ...
      <div className="relative h-[400px] sm:h-[500px] md:h-[600px] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <div className="absolute inset-0" style={{ backgroundColor: '#1F6367', opacity: 0.75 }}></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-start">
            ...
            >
              ...
              {/* Decorative Line */}
              <div className="w-full max-w-xs sm:max-w-md h-px mb-8 sm:mb-10 md:mb-12" style={{ background: 'linear-gradient(to right, transparent, #1F6367, transparent)' }}></div>
