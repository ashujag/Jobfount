...
export default function Header({ prometricLicensingRef }) {
  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 w-full transition-all duration-500 animate-[fadeIn_0.6s_ease-out] ${
        scrolled ? 'py-2' : 'py-4'
      }`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`bg-white/95 backdrop-blur-lg rounded-2xl shadow-lg transition-all duration-500 ${
