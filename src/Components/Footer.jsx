...
import JobfountLogo from 'C:/Users/lenovo/Documents/NewWebsite/my-app/src/assets/Jobfount.jpg'; // Updated image path

const JobfountFooter = () => {
  return (
     <footer className="bg-[#aeb1b6] border-t border-gray-800 py-6 sm:py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex flex-row justify-between items-center flex-wrap py-4">
          ...
          <div className="flex flex-col space-y-2 sm:space-y-3">
            ...
            <p className="text-xs text-black">© 2025 JobFount</p>
          </div>

          {/* Social */}
          <div>
            <h4 className="text-xs sm:text-sm font-semibold text-black mb-2 sm:mb-3">Social</h4>
