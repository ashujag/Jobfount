  ...
  return (
    <div ref={ref} id="prometric-licensing-section" className="min-h-screen bg-gradient-to-br from-gray-50 via-slate-50 to-gray-100 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        <div className="absolute top-10 sm:top-20 -left-10 sm:-left-20 w-40 sm:w-80 h-40 sm:h-80 rounded-full opacity-5" style={{ background: '#164d61' }}></div>
        ...
        <div className="absolute bottom-10 sm:bottom-20 left-1/4 sm:left-1/3 w-36 sm:w-72 h-36 sm:h-72 rounded-full opacity-5" style={{ background: '#164d61' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 relative z-10">
          ...
          >
            <div className="inline-flex items-center justify-center mb-4 sm:mb-6">
              <div className="relative">
                <Globe className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20" style={{ color: '#164d61' }} />
        ...
        <div 
          ...
          style={{ opacity: 0, transform: 'translateY(30px)' }}
        >
          <div className="bg-gradient-to-r from-gray-50 to-slate-50 border-l-4 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-10 shadow-md" style={{ borderLeftColor: '#164d61' }}>
