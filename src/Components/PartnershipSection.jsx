...
import { Handshake, Users, FileText, Target, CheckCircle, ArrowRight } from 'lucide-react';
...
const PartnershipSection = () => {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Complete handling of all paperwork, applications, and administrative tasks",
      bgColor: "#E63946"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-slate-50 to-gray-100 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-20 sm:bottom-40 left-5 sm:left-10 w-40 sm:w-64 md:w-80 h-40 sm:h-64 md:h-80 rounded-full opacity-5" style={{ backgroundColor: '#0a1436ff' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-12 md:py-16 lg:py-20 relative z-10">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16 lg:mb-24">
          ...
          >
            <div className="inline-flex items-center justify-center mb-3 sm:mb-4 md:mb-6 relative">
              <Handshake className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 lg:w-20 lg:h-20" style={{ color: '#0a1436ff' }} />
          ...
          <div 
            ...
            style={{ opacity: 0, transform: 'translateY(30px)' }}
          >
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-800 font-semibold leading-relaxed" style={{ fontFamily: 'Anton, sans-serif' }}>
              We bring verified candidates to your institute or center, manage application flow, and handle documentation.
            </p>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed" style={{ fontFamily: 'Anton, sans-serif' }}>
              You focus on training or testing — we handle coordination and candidate management.
            </p>
          </div>
        </div>
        ...
        <div className="mb-10 sm:mb-12 md:mb-16 lg:mb-24 px-4 sm:px-0">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-6 sm:mb-8 md:mb-12" style={{ fontFamily: 'Anton, sans-serif' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4" style={{ fontFamily: 'Anton, sans-serif' }}>
                  {benefit.title}
                </h3>
                <p className="text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed" style={{ fontFamily: 'Anton, sans-serif' }}>
                  {benefit.description}
                </p>
              </div>
            ))}
        ...
        <div className="mb-10 sm:mb-12 md:mb-16 lg:mb-24 px-4 sm:px-0">
          <div 
            ...
            style={{ background: 'linear-gradient(135deg, #0a1436ff 0%, #E63946 100%)' }}
          >
            ...
            <div className="relative z-10">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6 sm:mb-8 md:mb-12" style={{ fontFamily: 'Anton, sans-serif' }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6 max-w-4xl mx-auto">
                {focusPoints.map((point, index) => (
                  ...
                  >
                    ...
                    <p className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-gray-900" style={{ fontFamily: 'Anton, sans-serif' }}>{point}</p>
                  </div>
                ))}
              </div>
            </div>
